...
import { toggleDriverStatus, createDriver, getDriversWithStats, resetDriverPassword } from '@/app/(admin)/actions/delivery-actions'
            ...
            {drivers.map(driver => (
              <tr key={driver.id} className="hover:bg-[#F8F7F5]/50 transition-colors">
                ...
                <td className="px-6 py-4 text-center">
                   <span className="text-lg font-bold">{driver.ordersToday}</span>
                </td>
